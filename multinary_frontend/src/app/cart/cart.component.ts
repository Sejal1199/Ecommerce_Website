...
export class CartComponent implements OnInit {
  ...
  deleteCart(index:number)
  {
    ...
    for(let i of this.cart)
    {
      this.deleteFinal_total = this.deleteFinal_total + i.product_total;
    }
    console.log(this.deleteFinal_total);
    this.final_total = this.deleteFinal_total;
 ...
 let  address = this.address;
  let    user = "5ef1ad34afcb8d23b472f3a7";
  //var temp = localStorage.getItem("user_id");
  // console.log(temp);
  //let user = temp;
